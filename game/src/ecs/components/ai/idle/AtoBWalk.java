...
public class AtoBWalk implements IIdleAI{
    ...
    public void idle(Entity entity) {
        if (posA == null && posB == null){
            ...
            pathAB = AITools.calculatePath(posA.getCoordinateAsPoint(), posB.getCoordinateAsPoint());
            pathBA = AITools.calculatePath(posB.getCoordinateAsPoint(), posA.getCoordinateAsPoint());
            path = pathAB;
        }
