...
public class GameOverMenu <T extends Actor> extends ScreenController<T> {
        ...
        public GameOverMenu(SpriteBatch batch) {
            ...
            //Der Restart Button
            ScreenButton restart = new ScreenButton("Restart Game", new Point(0, 0), new TextButtonListener() {
                @Override
            ...
            //Beenden des Games
            ScreenButton quiet = new ScreenButton("Quit Game", new Point(0, 0), new TextButtonListener() {
                @Override
                public void clicked(InputEvent event, float x, float y) {
                    Game.end();
                }
